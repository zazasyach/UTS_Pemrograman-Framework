...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a class="btn-getstarted" href="<?php echo e(route('home')); ?>">Coba Disini!</a>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            ...
            <div class="d-flex">
              <a href="<?php echo e(route('home')); ?>" class="btn-get-started">Coba Disini!</a>
...
<?php /**PATH C:\xampp\htdocs\UTS_PF\resources\views/welcome.blade.php ENDPATH**/ ?>